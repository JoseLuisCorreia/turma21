...
public static void main (String[]args) {	
	...
	EnsinoPos pos = new EnsinoPos(0, "aaa", 0, true);
	...
	if(auxAtivo == '1') {
		...
		System.out.println("Você ngostaria de add ou tirar nota? Digite:\n(1) - Adiciona\n(2) - Tira");
		auxAtivo = leia.next().charAt(0);
	...
	//System.out.println("Ensino Pós e matrícula n° " + pos.getMatricula() );
